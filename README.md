# Pocket Dimensions
This project introduces a fascinating item to the game. It's similar to a bundle, but with a room inside. You can build whatever you want inside and take it with you!

## How to use it
![Item Preview](https://cdn.modrinth.com/data/cached_images/5e3ae33eb9427c0d3a17d5a678f16d941fc87b4b.png)
...
## Expansions
If you would like to use alternative textures with this pack, you can install <sub><a href="https://modrinth.com/resourcepack/new-pocket-dimension">[![Dynamic JSON Badge](https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fapi.modrinth.com%2Fv2%2Fproject%2Ficpz8Bnp&query=slug&style=flat-square&logo=modrinth&label=%20&color=gray)](https://modrinth.com/resourcepack/new-pocket-dimension)</a></sub> to enhance your experience even further!

## Customization
![Example Room](https://github.com/MavLeague/pocket_dimension/blob/main/media/example_room.gif?raw=true)

You can create whatever you can imagine! Start now and build your own pocket dimension!
